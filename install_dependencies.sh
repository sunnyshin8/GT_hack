#!/bin/bash
# Installation script for GT_hack FastAPI Chatbot
# Run this script to install dependencies in the correct order
...
# Stage 2: Database and basic utilities
...
# Stage 3: HTTP and logging
echo "📦 Stage 3: Installing HTTP client and logging..."
pip install httpx==0.25.2 structlog==23.2.0 faker==19.6.2

# Stage 4: Redis (optional)
echo "📦 Stage 4: Installing Redis (optional)..."
pip install redis[hiredis]==5.0.1 || echo "⚠️ Redis installation failed - continuing without it"

# Stage 5: Google Gemini AI
